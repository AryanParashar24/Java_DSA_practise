...
//So iin the selection sort algorithm we can see that the sorting is done by sorting the elements one ny one for example for first time we will arrange the max
//in the last place and then we can make end-1 as the second last one and then make them sort into the way so as to mak it sort into the whole way
public class Main {
